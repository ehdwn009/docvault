...
**버전 숫자 읽는 법**: Ubuntu는 `연도.월` 형식입니다 — **22.04 = 2022년 4월 출시**. 매년 4월·10월에 새 버전이 나오고, 그중 **짝수 해 4월판(20.04, 22.04, 24.04...)만 LTS**(Long Term Support, 5년 보안 패치 보장)입니다. 나머지는 9개월 만에 지원이 끝나요. **서버는 항상 LTS를 씁니다** — 홀수 버전을 서버에 깔면 1년도 안 돼 보안 패치가 끊깁니다. 22.04와 24.04 둘 다 LTS라 어느 쪽도 괜찮지만, 이 가이드는 자료가 가장 많이 쌓인 22.04 기준입니다.
